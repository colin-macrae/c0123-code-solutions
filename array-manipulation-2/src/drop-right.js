...
// usually we start on the left and go right.  you set the start point from the left side.  0 is the first index.  you can skip the first, second etc.  here we will do the opposite, and start at an index away from the endpoing (e.g. array.length minus an amount), and move left
